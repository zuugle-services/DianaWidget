            ...
            <div class="slider-wrapper etc">
                <div class="widget-header">
                    <div class="widget-header-button">
                        <button id="backBtn" class="back-btn-arrow" aria-label="${t('ariaLabels.backButton')}">
            ...
            <div class="results-content-area">
                <div class="collapsible-container" id="collapsibleToActivity">
                    ...
                    <svg class="accordion-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4.5 10.5L8 6.5L11.5 10.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
